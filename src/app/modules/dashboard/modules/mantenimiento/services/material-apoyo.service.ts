...
export class MaterialApoyoService {
  ...
  public getMaterialApoyo(page:number = 1,materialName: string = '', pageSize: number = 10) {
    return  this.helperHandler.handleRequest(() => this.http.get(`${this.baseURL}/MaterialesDeApoyo?CurrentPage=${page}&PageSize=${pageSize}&buscar=${materialName}`, this.header))
  }
